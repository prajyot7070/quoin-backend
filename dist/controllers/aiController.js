...
exports.generateAndExecuteQuery = exports.generateQuery = void 0;
...
const generateQuery = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const schemaInfo = yield (0, schemaformater_1.getDatabaseSchema)(connectionId, connection.catalog);
...
const generateAndExecuteQuery = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const { prompt, connectionId } = req.body;
    try {
    ...
    Generate a valid TrinoSQL query based on the user's request. 
     ONLY the SQL query without any explanation or comments.`;
        ...
        const executionResult = yield trinoService_1.default.executeQuery(connectionId, query);
...
exports.generateAndExecuteQuery = generateAndExecuteQuery;
